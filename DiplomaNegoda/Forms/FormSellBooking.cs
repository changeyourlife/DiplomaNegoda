...
namespace DiplomaNegoda.Forms
{
    public partial class FormSellingReservationing : Form
    {
        ...
        public string numberOfFlight, fromCity, toCity, goDate, goTime, arriveDate, arriveTime, costEco, costBus;

        public FormSellingReservationing(string NumberOfFlight, string FromCity, string ToCity, string GoDate, string GoTime, string ArriveDate, string ArriveTime, string CostEco, string CostBus)
        {
            InitializeComponent();
